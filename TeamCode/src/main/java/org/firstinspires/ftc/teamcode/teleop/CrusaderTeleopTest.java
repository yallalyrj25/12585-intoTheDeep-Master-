...
@TeleOp(name="TeleopTest", group="Pushbot") //is you want to duplicate change this name
//@Disabled
public class CrusaderTeleopTest extends OpMode { //make sure you change this too
